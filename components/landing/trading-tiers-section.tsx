...
import { TRADING_PLANS } from "@/lib/config/plans";
...
export function TradingPlansSection() {
  const { p } = useLanguage();
                ...
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Plans {plan.id}</p>
                    </div>
                  </div>
