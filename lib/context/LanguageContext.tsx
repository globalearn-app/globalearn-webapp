...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "plans.title": "Daily Investment Plans",
    "plans.subtitle": "Choose the plan that fits your investment goals",
    "tiers.title": "Daily Investment Plans",
  ...
  es: {
    ...
    "plans.title": "Planes de Inversión Diaria",
    "tiers.title": "Planes de Inversión Diaria",
  ...
  fr: {
    ...
    "plans.title": "Plans d'Investissement Quotidiens",
    "tiers.title": "Plans d'Investissement Quotidiens",
  ...
  de: {
    ...
    "plans.title": "Tägliche Investitionspläne",
    "tiers.title": "Tägliche Investitionspläne",
  ...
  ar: {
    ...
    "plans.title": "خطط الاستثمار اليومية",
    "tiers.title": "خطط الاستثمار اليومية",
  ...
  hi: {
    ...
    "plans.title": "दैनिक निवेश योजनाएं",
    "tiers.title": "दैनिक निवेश योजनाएं",
